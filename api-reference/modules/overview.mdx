...
| Wallet top-up | Payment `SUCCESS` (WALLET_TOPUP type) | Balance updated in `customer_wallets` |
| Insurance purchase | Payment `SUCCESS` + `POST /insurance/purchase` | Policy row created; NH policy issued via Narayana Health API |
